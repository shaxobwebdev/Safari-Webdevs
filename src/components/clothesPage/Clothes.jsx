          ...
          <div className="flex justify-center items-center w-full mb-[500px]">
            <div className="flex justify-between w-[95%] items-center">
              <div className=" flex flex-col pt-[200px] w-[25%]">
                ...
                <div className=" absolute ml-[420px]  w-[74%] mt-[45px]  h-[1px] bg-slate-950 "></div>
                <hr className="w-[400px] h-5" />
                <div className="">
                  <h1 className=" uppercase text-[#777] text-[24px] mb-2">
                    all
                  </h1>
                  <h1 className=" uppercase text-[#777] text-[24px] mb-2">
                    dress
                ...
                <div className="mt-3">
                  <h1 className="mb-3  uppercase text-[30px]">size</h1>
              ...
              <div className="w-[70%]">
                <div>
                  <select className="outline-none w-[200px] h-10 border-2 border-[#000] text-center absolute right-10 top-[200px]">
                    <option value="sort by: most popular">Shopping</option>
                    <option value="sort by: most popular">Karzinka</option>
                    <option value="best silling">Best</option>
                    <option value="price: high to low">Hero</option>
                    <option value="price: high to high">Prite</option>
                  </select>
                </div>
                <div className="text-center mx-auto h-[100%] flex flex-col absolute top-[350px]">
                  <div className="grid items-center justify-center w-full grid-cols-3 gap-8">
                    {filteredUsers?.map((item) => {
                      return (
                        <div className="flex flex-col items-center relative  w-[420px] h-[460px] pt-5 rounded-lg mx-auto cursor-pointer hover:shadow-slate-500 hover:shadow-2xl">
